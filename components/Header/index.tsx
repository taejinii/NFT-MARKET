...
export default function Header() {
  ...
  return (
    <nav
      className={`flex justify-between font-bold font-sans text-2xl text-black items-center responsive-container  w-full  fixed top-0 h-16 z-50 duration-300 drop-shadow-md ${
